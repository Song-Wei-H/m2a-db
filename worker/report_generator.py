                ...
                .options(
                    load_only(
                        ...
                        ToolResult.open_port_id,
                            ...
                            ToolResult.investigation_id,
                            ToolResult.action_id,
        ...
        tool_tasks_data = [
            {
                ...
                "execution_authorization_id": getattr(task, "execution_authorization_id", None),
                "lineage_state": "current_pending" if task.status == "pending" else "historical",
